...
if __name__ == '__main__':
    ...
    history = supervised_model.fit(SL_states, np.eye(4)[SL_labels.astype('int')], 64, nb_epoch=128, verbose=2, validation_data=(SL_val_states, np.eye(4)[SL_val_labels.astype('int')]), shuffle=True, callbacks=[keras.callbacks.EarlyStopping(min_delta=0.0005, patience=5), keras.callbacks.ProgbarLogger()])
