...
class AI(object):
    ...
    def getNextMove(self, grid):
      ...
      # print 't=%.2fs, eval=%d, node=%d, total_eval=%d, total_node=%d, %fnps' % (t1-t0, self.eval_count, self.node_count, self.total_eval, self.total_node, (self.total_node+self.total_eval)/self.total_time)
